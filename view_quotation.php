                                        ...
                                        <div class="invoice-header">
                                            ...
                                            <div class="col-lg-12">
                                                <table class="table table-bordered">
                                                    <thead>
                                                        <!-- <tr> -->
                                                            <h5>Client and Quotation Details</h5>
                                                        <!-- </tr> -->
                                                    </thead>
                                                    <tbody>
                                                        <tr>
                                                                ...
                                                                <table class="table mb-0">
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td><?php echo htmlspecialchars($client['client_name']); ?>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><strong>Email:</strong></td>
                                                                            <td><?php echo htmlspecialchars($client['email']); ?>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><strong>Phone:</strong></td>
                                                                            <td><?php echo htmlspecialchars($client['phone']); ?>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                                ...
                                                                <table class="table mb-0">
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td><?php echo htmlspecialchars($quotation['created_at']); ?>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><strong>Quotation ID:</strong></td>
                                                                            <td><?php echo htmlspecialchars($quotation_id); ?>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
